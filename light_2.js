...
const fetchLighthouseReport = async (url, apiKey, progressBar, Queue) => {
    ...
    try {
        ...
        console.error(`Error fetching Lighthouse report for light_2 at ${url}:`, error.message);
    }
};
...
const main_2 = async (realUrls) => {
    const apiKey = 'AIzaSyCDG1ExVQb7rvQ6dFsmCZuHkzc4TvMSGVE';
